...
//
// public class ReflectionBasedTest
// {
//     [Fact]
...
//
//         var mapper = new ReflectionBasedMapper(builder.Build(), ArraySegment<ICustomTypeMapper>.Empty);
...
//         var mapper = new ReflectionBasedMapper(configuration, new []{new ListToArrayMapper()});
...
//         var mapper = new ReflectionBasedMapper(mapperConfig, ArraySegment<ICustomTypeMapper>.Empty);
